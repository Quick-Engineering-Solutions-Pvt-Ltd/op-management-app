...
const Navbar: React.FC<NavbarProps> = ({ toggleSidebar, isSidebarOpen }) => {
  ...
  return (
    <>
      <nav className="bg-white px-2 sm:px-4 py-2 flex flex-wrap items-center shadow-[5px_5px_15px_#d1d9e6,-5px_-5px_15px_#ffffff] mb-4">
        ...
        <div className="flex-1 flex justify-center order-2 sm:order-none">
          <img src="/images/logo.png" alt="Logo" className="w-28 sm:w-40 h-auto" />
        </div>
        {/* Right section */}
          ...
          <Menu as="div" className="relative">
            <MenuButton className="flex items-center focus:outline-none">
              ...
              <div className="hidden sm:block text-left">
                <div className="text-gray-800 text-base sm:text-lg font-semibold">{user.username}</div>
